...
const DATOS_SEMILLA = {
    [UniStorage.CLAVES.USUARIOS]: [
        ...
        { id:"U006", correo:"lbeltran@espe.edu.ec",  password:"docente123",  rol:"docente",    refId:"D001", nombreCompleto:"Ing. Luis Beltran" },
        { id:"U007", correo:"vsuarez@espe.edu.ec",   password:"docente123",  rol:"docente",    refId:"D002", nombreCompleto:"Ing. Valeria Suárez" },
        { id:"U008", correo:"mandrade@espe.edu.ec",  password:"docente123",  rol:"docente",    refId:"D003", nombreCompleto:"Ing. Marco Andrade" },
        { id:"U009", correo:"ggnarvaez@espe.edu.ec", password:"docente123",  rol:"docente",    refId:"D004", nombreCompleto:"Ing. Gabriel Gustavo Narváez" }
    ],
    ...
    [UniStorage.CLAVES.MATERIAS]: [
        { codigo:"23758", nombre:"Estructura de Datos",    creditos:4, semestre:6, docente_id:"D001", periodo_id:"2026-1" },
        { codigo:"54125", nombre:"Ingeniería de Software", creditos:3, semestre:6, docente_id:"D002", periodo_id:"2026-1" },
        { codigo:"26485", nombre:"Cálculo Diferencial",    creditos:4, semestre:6, docente_id:"D003", periodo_id:"2026-1" },
        { codigo:"25485", nombre:"Redes de Computadoras",  creditos:4, semestre:6, docente_id:"D004", periodo_id:"2026-1" }
    ],
